...
export default function AdminUsers() {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'var(--sp-5)' }}>
      ...
      {/* Filtered empty state — users exist but none match filters */}
      {users.length > 0 && paginated.length === 0 && !loading && (
        <div style={{ textAlign:'center', padding:'var(--sp-12)', background:'var(--white)', border:'1px solid var(--ink-200)', borderRadius:16 }}>
          <Users size={36} strokeWidth={1} style={{ margin:'0 auto var(--sp-3)', display:'block', color:'var(--ink-300)' }} />
          <p style={{ fontSize:15, fontWeight:600, color:'var(--ink-700)', marginBottom:6 }}>No users match your filters</p>
