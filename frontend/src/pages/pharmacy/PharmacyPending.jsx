...
export default function PharmacyPending() {
  ...
  // Auto-redirect when admin approves the application
  useEffect(() => {
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        ...
        >
          ...
          <div className={styles.tag}>Under Review</div>
          <h1 className={styles.title}>Your application is being verified</h1>
          <p className={styles.sub}>
            Hi <strong>{user?.name || 'there'}</strong>, our compliance team is reviewing your documents.
            This typically takes <strong>24–48 hours</strong>. You'll be notified via SMS and email once approved.
          </p>

          <div className={styles.refBox}>
            <span className={styles.refLabel}>Application Reference</span>
            <span className={styles.refId}>MMED-2026-4829</span>
          </div>
